...
describe("getEnvPaths", () => {
  describe("on darwin", () => {
    ...
    it("should return the env paths using xdgBasedir", () => {
      ...
      expect(envPaths.data).toEqual("/home/usr/.local/share/codex")
      expect(envPaths.config).toEqual("/home/usr/.config/codex")
      expect(envPaths.runtime).toEqual("/tmp/runtime/codex")
    })
